...
namespace AtlasAddressBook.Data.Migrations
{
    ...
    [Migration("20220201172432_Initial_0002")]
    partial class Initial_0002
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasAddressBook.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("AtlasAddressBook.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CategoryContact", b =>
                {
                    b.HasOne("AtlasAddressBook.Models.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AtlasAddressBook.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
